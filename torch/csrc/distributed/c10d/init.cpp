...
An enum-like class for built-in communication hooks: ``ALLREDUCE`` and ``FP16_COMPRESS``.)")
  ...
  shared_ptr_class_<::c10d::Reducer>(module, "Reducer")
      ...
      .def(
          ...
          py::call_guard<py::gil_scoped_release>())
      .def(
          "_get_forward_buckets",
          [](::c10d::Reducer& reducer) {
            return reducer.get_forward_buckets();
          },
          py::call_guard<py::gil_scoped_release>())
      .def(
          "_get_algorithm_key",
          [](::c10d::Reducer& reducer) {
            return reducer.get_algorithm_key();
          },
          py::call_guard<py::gil_scoped_release>())
      .def(
          "_copy_forward_work_result",
          &::c10d::Reducer::copy_forward_work_result,
          py::arg("bucket_index"),
          py::arg("bucket_tensor"),
          py::call_guard<py::gil_scoped_release>())
      .def(
          "_construct_current_buckets",
          &::c10d::Reducer::construct_current_buckets,
          py::arg("index"),
          py::call_guard<py::gil_scoped_release>())
      .def(
